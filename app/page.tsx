      ...
      <main>
        <section className="md:w-[60%] mx-auto flex flex-col gap-5">
          ...
          <p className="text-slate-800 dark:text-white mt-5 text-center md:w-[80%] md:p-0 mx-auto p-1 duration-300">
            Accelerate and enhance your reading experience with this
            summarization tool, a freely available article summarizer that
            converts extensive articles into easily understandable and brief
            summaries.
          </p>
          <Input />
        </section>
